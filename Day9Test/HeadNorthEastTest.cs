...
public class HeadNorthEastTest
{
    [Fact]
    public void GivenStartPosition_WhenCreateState_EndsInCorrectLocation()
    {
        ...
        // Act
        var sut = new HeadNorthEast(headPosition);
