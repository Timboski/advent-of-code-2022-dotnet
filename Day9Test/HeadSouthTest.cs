...
public class HeadSouthTest
{
    ...
    public void GivenStartPosition_WhenCreateState_EndsInCorrectLocation()
    {
        ...
        // Act
        var sut = new HeadSouth(headPosition);
    ...
    [Fact]
    public void GivenStartingState_WhenMoveNorth_EndsOverlap()
    {
        // Arrange
        var startPosition = new EndPosition(0, 0);
        var endPosition = new EndPosition(0, 1);
        var sut = new HeadSouth(startPosition);
    ...
    [Fact]
    public void GivenStartingState_WhenMoveSouth_BothEndsMoveSouth()
    {
        // Arrange
        var startPosition = new EndPosition(0, 0);
